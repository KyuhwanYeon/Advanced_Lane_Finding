...
if __name__ == '__main__':
    if input_type == 'image':
        ...
        ax4.set_title('unwarp_img', fontsize=10)        
        ax5.imshow(lane_img)
        ax5.set_title('find_lane', fontsize=10)  
        ax6.imshow(fill_lane_img)
        ax6.set_title('fill_lane', fontsize=10) 
        ax7.imshow(rewarp_img)
        ax7.set_title('warp_img', fontsize=10) 
        ax8.imshow(result)
        ax8.set_title('final_result', fontsize=10) 
