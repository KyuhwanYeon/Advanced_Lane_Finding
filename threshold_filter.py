...
# Run the function
sobel_x_grad_binary = abs_sobel_thresh(image, orient='x', thresh_min=30, thresh_max=100)
sobel_y_grad_binary = abs_sobel_thresh(image, orient='y', thresh_min=30, thresh_max=255)
mag_thresh_grad_binary = mag_thresh(image ,sobel_kernel=3, mag_thresh =(30,100))
dir_thresh_grad_binary = dir_threshold(image, sobel_kernel=3, thresh=(0.4, 1.3))
